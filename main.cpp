...
int main(int argc,char** argv){
	// Paths can be overridden on the command line; defaults preserve old behaviour.
	//   argv[1] = input L-system string file
	//   argv[2] = output streams file
	//   argv[3] = output points file
	std::string inPath  = (argc>1)?argv[1]:"../streamTree3D_withWidth_2_blender/LSYOUT.txt";
	std::string outStreams = (argc>2)?argv[2]:"../streamTree3D_withWidth_2_blender/Streams.txt";
	std::string outPoints  = (argc>3)?argv[3]:"../streamTree3D_withWidth_2_blender/Points.txt";
